...
/**
 * A command that ejects the first piece by running the roller at ROLLER_FIRST_EJECT_VALUE
 * for 0.5 seconds.
 */
public class EjectFirstPieceCommand extends Command {
    private final KitBot m_kitbot;
    private final double m_duration = 0.5; // seconds
    private long m_startTime;

    /**
     * Creates a new EjectFirstPieceCommand.
     *
     * @param kitbot The KitBot subsystem
     */
    public EjectFirstPieceCommand(KitBot kitbot) {
        m_kitbot = kitbot;
